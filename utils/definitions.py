ALL_DOMAINS = ["attraction", "hotel", "restaurant", "taxi", "train", "hospital", "police", "weather", "navigate", "schedule"]
...
ALL_REQSLOT = ["car", "address", "postcode", "phone", "internet", "parking", "type", "pricerange", "food",
               ...
               "distance", "room", "weather_attribute", "poi", "traffic_info", "address", "event", "date", "time", "party", "agenda"
...
INFORMABLE_SLOTS = {
    ...
    ,
    "schedule": ["event", "date", "time", "room", "agenda", "party"],
    "navigate": ["poi_type", ],
...
ALL_INFSLOT = ["type", "parking", "pricerange", "internet", "stay", "day", "people", "area", "stars", "name",
               ...
               "event", "date", "time", "room", "agenda", "party",
               "poi_type",
               "date", "location", "weather_attribute",
