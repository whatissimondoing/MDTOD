...
def add_config(parser):
    ...
    group.add_argument("-add_du_dual", type=int, default=0)  # Dual learning for utterance and dialog states
    # group.add_argument("-add_dr_dual", type=int, default=0)  # Dual learning for dialog states and response
    group.add_argument("-add_ru_dual", type=int, default=0)  # Dual learning for utterance and response
    group.add_argument("-du_coeff", type=float, default=0.05)
    group.add_argument("-ru_coeff", type=float, default=0.05)
    group.add_argument("-optimizer", type=str, default="adamw",
                       choices=["adamw", "adafactor"])
    group.add_argument("-train_ratio", type=float, default=1.0)
    group.add_argument("-para_num", type=int, default=-1)
    ...
    group.add_argument("-num_gpus", type=int, default=4)
    group.add_argument("-memo", type=str, default=None)
